...
const Blog = () => {
    return (
        <div className='container'>
            <h4 className='text-success text-center py-10'>Here are some frequently asked question</h4>
            <div className='row '>
                <div className="card QNA-card  ">
                    <div className="card-body">
                        <h5 className="card-title ">1.What are Tell us the differences between uncontrolled and controlled components?</h5>
                ...
                <div className="card QNA-card ">
                    <div className="card-body">
                        <h5 className="card-title ">2. How to validate React props using PropTypes?</h5>
                ...
                <div className="card QNA-card  ">
                    <div className="card-body">
                        <h5 className="card-title ">3. What are the difference between nodejs and express js?</h5>
